...
public class FruitVegObj {
    ...
    /**
     * Mutator method for the Quantity of the product
    ...
    public String toString() {
        ...
        return "FruitVegObj{" + "name=" + name + ", expiryDate=" + dateFormat.format(expiryDate.getTime()) + ", quantity=" + quantity + ", unit=" + unit + ", batchNumber=" + batchNumber + ", unitCost=" + unitCost + ", unitPrice=" + unitPrice + ", unitDisposalCost=" + unitDisposalCost + '}';
    }
 ...
 * Sorting Comparator - Sort by expiry date
 */
class QuantityComparator implements Comparator<FruitVegObj> {
    @Override
    /**
     * Overrides comparator compare method to compare the Expiry Date attribute of the two products
     * @param product1 The first product to be compared
